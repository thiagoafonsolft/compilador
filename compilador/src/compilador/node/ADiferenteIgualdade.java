...
public final class ADiferenteIgualdade extends PIgualdade
{
    private TDiferente _diferente_;

    public ADiferenteIgualdade()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferenteIgualdade(
    ...
    {
        ((Analysis) sw).caseADiferenteIgualdade(this);
    }
