...
public final class AVirgulaVarVirgulaOp extends PVarVirgulaOp
{
    private PVar _var_;
    private TVirgula _virgula_;

    public AVirgulaVarVirgulaOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVirgulaVarVirgulaOp(
    ...
    {
        ((Analysis) sw).caseAVirgulaVarVirgulaOp(this);
    }
