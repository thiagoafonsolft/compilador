...
public final class AMaiorRelacionalMaior extends PRelacionalMaior
{
    private TMaior _maior_;

    public AMaiorRelacionalMaior()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorRelacionalMaior(
    ...
    {
        ((Analysis) sw).caseAMaiorRelacionalMaior(this);
    }
