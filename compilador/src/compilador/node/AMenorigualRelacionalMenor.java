...
public final class AMenorigualRelacionalMenor extends PRelacionalMenor
{
    private TMenorigual _menorigual_;

    public AMenorigualRelacionalMenor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorigualRelacionalMenor(
    ...
    {
        ((Analysis) sw).caseAMenorigualRelacionalMenor(this);
    }
