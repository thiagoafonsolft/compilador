...
public final class AMaiorigualRelacionalMaior extends PRelacionalMaior
{
    private TMaiorigual _maiorigual_;

    public AMaiorigualRelacionalMaior()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorigualRelacionalMaior(
    ...
    {
        ((Analysis) sw).caseAMaiorigualRelacionalMaior(this);
    }
